...
void rfid()
{
  ...
  if (content.substring(1) == "43 72 4B 63" && state == 1)
  {
    if (card1Balance >= 10)
    {
      lcdPrint();
  ...
  else if (content.substring(1) == "43 72 4B 63" && state == 2)
    {
      lcd.setCursor(0,0);
  ...
  else if (content.substring(1) == "73 74 BD 1D" && state == 1)
  {
    if (card2Balance >= 10)
    {
      lcdPrint();
...
else if (content.substring(1) == "73 74 BD 1D" && state == 2)
    {
      lcd.setCursor(0,0);
      digitalWrite(buzzerPin, HIGH);
      lcd.print ("Access denied");
